...
class Block(object):
    ...
    def __init__(self, path, name, index):
        ...
        self.clips = Block.get_clips(path)
        data, chans, width, rate, frames, clipslist = Block.merge_clips(self.clips)
...
class BlockPart(object):
    ...
    def __init__(self, name, index):
        ...
        self.start = int(name.split("-")[0])
        self.end = int(name.split("-")[1])
